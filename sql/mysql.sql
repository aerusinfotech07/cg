--
-- MySQL sample database (Northwind-style)
-- For SQL topic details and examples, refer to the notes in this folder:
--
--   01-Introduction-to-SQL-Notes.md   - What is SQL, RDBMS, tables
--   02-SQL-Syntax-Notes.md            - Statements, keywords, important commands
--   03-SQL-SELECT-Statement-Notes.md  - SELECT, columns, SELECT *
--   04-SQL-SELECT-DISTINCT-Notes.md   - DISTINCT, COUNT(DISTINCT)
--   05-SQL-WHERE-Clause-Notes.md      - Filtering, operators (=, >, LIKE, IN, etc.)
--   06-SQL-ORDER-BY-Notes.md          - Sorting ASC/DESC, multiple columns
--   07-SQL-AND-Operator-Notes.md     - Multiple conditions (all must be TRUE)
--   08-SQL-OR-Operator-Notes.md      - Multiple conditions (any can be TRUE)
--   09-SQL-NOT-Operator-Notes.md     - NOT, NOT LIKE, NOT BETWEEN, NOT IN
--   10-SQL-INSERT-INTO-Notes.md       - Insert new records, one or multiple rows
--   11-SQL-NULL-Values-Notes.md       - NULL meaning, IS NULL, IS NOT NULL
--   12-SQL-UPDATE-Statement-Notes.md  - UPDATE, SET, WHERE (single/multiple rows)
--   13-SQL-DELETE-Statement-Notes.md  - DELETE, WHERE, delete all rows, DROP TABLE
--   14-SQL-SELECT-TOP-LIMIT-FETCH-Notes.md - TOP, LIMIT, FETCH FIRST (limit rows)
--   15-SQL-Aggregate-Functions-Notes.md   - MIN, MAX, COUNT, SUM, AVG, NULL handling
--   16-SQL-MIN-Function-Notes.md         - MIN(), smallest value, alias, GROUP BY
--   17-SQL-MAX-Function-Notes.md         - MAX(), largest value, alias, GROUP BY
--   18-SQL-COUNT-Function-Notes.md       - COUNT(*), COUNT(column), COUNT(DISTINCT), GROUP BY
--   19-SQL-SUM-Function-Notes.md         - SUM(), WHERE, alias, GROUP BY, expression, JOIN
--   20-SQL-AVG-Function-Notes.md         - AVG(), WHERE, alias, subquery, GROUP BY
--   21-SQL-LIKE-Operator-Notes.md        - LIKE, % and _ wildcards, starts/ends/contains
--   22-SQL-Wildcards-Notes.md            - %, _, [], ^, - (database-specific wildcards)
--   23-SQL-IN-Operator-Notes.md         - IN, NOT IN, IN (SELECT), NOT IN (SELECT)
--   24-SQL-BETWEEN-Operator-Notes.md    - BETWEEN, NOT BETWEEN, text, dates, with IN
--   25-SQL-Aliases-Notes.md             - Column/table aliases (AS), spaces, CONCAT, JOIN
--   26-SQL-Joins-Notes.md               - INNER, LEFT, RIGHT, FULL JOIN; ON clause
--   27-SQL-INNER-JOIN-Notes.md          - INNER JOIN syntax, table prefix, multiple tables
--   28-SQL-LEFT-JOIN-Notes.md           - LEFT JOIN, unmatched as NULL, WHERE IS NULL
--   29-SQL-RIGHT-JOIN-Notes.md          - RIGHT JOIN, all right rows, unmatched as NULL
--   30-SQL-FULL-JOIN-Notes.md           - FULL JOIN, both tables; MySQL UNION workaround
--   31-SQL-Self-Join-Notes.md           - Self join (table with itself), aliases, same city example
--   32-SQL-UNION-Operator-Notes.md      - UNION, UNION ALL, same columns, WHERE, alias
--   33-SQL-UNION-ALL-Operator-Notes.md  - UNION ALL, keeps duplicates, WHERE
--   34-SQL-GROUP-BY-Statement-Notes.md - GROUP BY, aggregates, ORDER BY, with JOIN
--   35-SQL-HAVING-Clause-Notes.md       - HAVING (filter groups), WHERE vs HAVING, with JOIN
--   36-SQL-EXISTS-Operator-Notes.md     - EXISTS (subquery returns rows), correlated subquery
--   37-SQL-ANY-Operator-Notes.md        - ANY (compare to subquery; TRUE if any match)
--   38-SQL-ALL-Operator-Notes.md        - ALL (compare to subquery; TRUE if every match)
--   39-SQL-SELECT-INTO-Statement-Notes.md - SELECT INTO (copy into new table); MySQL alternative
--   40-SQL-INSERT-INTO-SELECT-Statement-Notes.md - INSERT INTO SELECT (copy into existing table)
--   41-SQL-CASE-Expression-Notes.md    - CASE WHEN ... THEN ... ELSE ... END; categorize
--   42-SQL-NULL-Functions-Notes.md     - COALESCE, IFNULL, ISNULL, NVL, MS Access IsNull/IIf
--   43-SQL-Stored-Procedures-Notes.md  - CREATE PROCEDURE, parameters, EXEC; benefits
--   44-SQL-Comments-Notes.md           - Single-line (--), multi-line (/* */); MS Access
--   45-SQL-Operators-Notes.md          - Arithmetic, bitwise, comparison, compound, logical
--   46-SQL-CREATE-DATABASE-Statement-Notes.md - CREATE DATABASE; privileges; SHOW DATABASES
--   47-SQL-DROP-DATABASE-Statement-Notes.md   - DROP DATABASE; permanent deletion; IF EXISTS
--   48-SQL-BACKUP-DATABASE-SQL-Server-Notes.md - BACKUP DATABASE (full/differential); SQL Server
--   49-SQL-CREATE-TABLE-Statement-Notes.md    - CREATE TABLE; columns, datatypes; AS SELECT
--   50-SQL-DROP-TABLE-Statement-Notes.md     - DROP TABLE; TRUNCATE TABLE
--   51-SQL-ALTER-TABLE-Statement-Notes.md   - ALTER TABLE ADD/DROP/RENAME/ALTER COLUMN
--   52-SQL-Constraints-Notes.md            - NOT NULL, UNIQUE, PRIMARY KEY, FOREIGN KEY, CHECK, DEFAULT
--   53-SQL-NOT-NULL-Constraint-Notes.md    - NOT NULL on CREATE TABLE and ALTER TABLE
--   54-SQL-UNIQUE-Constraint-Notes.md     - UNIQUE on CREATE/ALTER; named; multiple columns; DROP
--   55-SQL-PRIMARY-KEY-Constraint-Notes.md - PRIMARY KEY on CREATE/ALTER; composite; DROP
--   56-SQL-FOREIGN-KEY-Constraint-Notes.md - FOREIGN KEY; child/parent; CREATE/ALTER; DROP
--   57-SQL-CHECK-Constraint-Notes.md       - CHECK constraint; CREATE/ALTER; DROP
--   58-SQL-DEFAULT-Constraint-Notes.md     - DEFAULT value; CREATE/ALTER; DROP; GETDATE()
--   59-SQL-CREATE-INDEX-Statement-Notes.md - CREATE INDEX; UNIQUE INDEX; DROP INDEX (by database)
--   60-SQL-AUTO-INCREMENT-Field-Notes.md  - AUTO_INCREMENT (MySQL), IDENTITY (SQL Server), SEQUENCE (Oracle)
--   61-SQL-Working-With-Dates-Notes.md    - Date types; date-only vs datetime; comparisons
--   62-SQL-Views-Notes.md                 - CREATE VIEW; CREATE OR REPLACE VIEW; DROP VIEW
--   63-SQL-Data-Types-Notes.md            - Data types for MySQL, SQL Server, MS Access
--
-- Tables in this script: categories, customers, employees, orders, order_details, products, shippers, suppliers
--
